...
async def auto_check_task(application):
    while True:
        ...
        next_run = now.replace(hour=16, minute=45, second=0, microsecond=0)
        if next_run < now:
        ...
        for chat_id in ALLOWED_CHAT_IDS:
            ...
            await check_domains(fake_update, SimpleNamespace(bot=application.bot), source_file="domains.json")
